...
\newtheorem{teor}[equation]{Teorema}
\newtheorem{prop}[equation]{Proposizione}
\newtheorem{lem}[equation]{Lemma}
\newtheorem{deff}[equation]{Definizione}
\newtheorem{cor}[equation]{Corollario}
\newtheorem*{oss}{Osservazione}
\newtheorem*{es}{Esempio}
\newtheorem{ez}[equation]{Esercizio}
\newcommand{\imp}[1]{{\color{red}\underline{$\bigstar$ {\color{black}#1}}}}
\newtheorem{teor+}[equation]{\imp{Teorema}}
\newtheorem{prop+}[equation]{\imp{Proposizione}}
\newtheorem{lem+}[equation]{\imp{Lemma}}
\newtheorem{deff+}[equation]{\imp{Definizione}}
\newtheorem{cor+}[equation]{\imp{Corollario}}
\newtheorem*{oss+}{\imp{Osservazione}}
\newtheorem*{es+}{\imp{Esempio}}
\newtheorem{ez+}[equation]{\imp{Esercizio}}
\newtheoremstyle{connome}{}{}{\itshape}{}{\bfseries}{.}{.5em}{\thmname{#3} \thmnumber{#2}}
\theoremstyle{connome}
\newtheorem{teorconnome}[equation]{Teorema}
\newtheoremstyle{connomesenzanumero}{}{}{\itshape}{}{\bfseries}{.}{.5em}{\thmname{#3}}
\theoremstyle{connomesenzanumero}
\newtheorem*{nota}{Nota}
\newtheoremstyle{connome+}{}{}{\itshape}{}{\bfseries}{.}{.5em}{\imp{\thmname{#3}} \thmnumber{#2}}
\theoremstyle{connome+}
\newtheorem{teorconnome+}[equation]{Teorema}
\newtheoremstyle{connomesenzanumero+}{}{}{\itshape}{}{\bfseries}{.}{.5em}{\imp{\thmname{#3}}}
\theoremstyle{connomesenzanumero+}
%\newtheorem{teorconnomesenzanumero}[equation]{Teorema}
\newtheorem*{nota+}{Nota}
%max min sup inf
\newcommand{\mmis}[2]{\ensuremath{\underaccent{#2}{\mbox{#1}\,\,}}}
\renewcommand{\max}[1]{\mmis{max}{#1}}
\renewcommand{\min}[1]{\mmis{min}{#1}}
\renewcommand{\sup}[1]{\mmis{sup}{#1}}
\renewcommand{\inf}[1]{\mmis{inf}{#1}}
\renewcommand{\lim}[1]{\mmis{lim}{#1}}
\renewcommand{\liminf}[1]{\mmis{liminf}{#1}}
\renewcommand{\limsup}[1]{\mmis{limsup}{#1}}
%altro
\newcommand{\mapstounderset}[4]{\ensuremath{\underset{#3}{#1}\underset{\mapsto}{\longrightarrow}\underset{#4}{#2}}}
\newcommand{\prs}[1]{\ensuremath{\left( #1 \right)}}
\renewcommand{\qedsymbol}{$\blacksquare$}
\renewcommand{\complement}{\ensuremath{^{\mathcal{C}}}}
\newcommand{\defi}{\ensuremath{\stackrel{\mbox{\scriptsize{\textit{def}}}}{=}}}
\newcommand{\norm}[1]{\ensuremath{\left|\left|#1\right|\right|}}
\newcommand{\nterm}[1]{\index{#1}{\color{ForestGreen}\textbf{\emph{\underline{#1}}}}}
...
PROGRAM lanczos
  ...
  ALLOCATE(rnd(n),t(n),alfa(iterations),r(n),v(n),w(n),z(n), &
       eig(iterations),beta(iterations),beta_tmp(n),alfa_tmp(n))
